 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_table' => array(
				'attractions', 'attractions_hotels', 'attractions_packages', 'attractions_tags', 'hotels', 'packages', 'tags', 'users', 'videos'
			),
		),
	);
